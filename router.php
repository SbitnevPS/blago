...
$routes = [
 ...
 '/admin/export' => ['file' => 'admin/export/index.php', 'name' => 'admin-export-archive'],
 '/admin/export/index' => ['file' => 'admin/export/index.php', 'name' => 'admin-export-archive-index'],
 '/admin/export/create' => ['file' => 'admin/export/create.php', 'name' => 'admin-export-archive-create'],
 '/admin/export/job' => ['file' => 'admin/export/job.php', 'name' => 'admin-export-archive-job-query'],
