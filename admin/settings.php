                ...
                <input type="hidden" name="settings_section" value="vk-integration">
                    ...
                    <div class="settings-vk-card">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-hint">Доступные переменные: {participant_name}, {participant_full_name}, {organization_name}, {region_name}, {work_title}, {drawing_title}, {contest_title}, {nomination}, {participant_age}, {age_category}</div>
                        </div>
                    </div>
                    <div class="settings-actions">
                        <button type="submit" class="btn btn--primary">
