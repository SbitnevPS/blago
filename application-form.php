...
<style>
 ...
 .application-note strong { display: block; margin-bottom: var(--space-xs); }
 ...
 .participant-form__remove:hover { background: var(--color-error); color: white; }
 ...
 .upload-area {
 position: relative; z-index:1; transition: all var(--transition-fast); cursor: pointer;
 }
        
 .upload-area.dragover {
 border-color: var(--color-primary); background: var(--color-primary-light); transform: scale(1.02);
 }
        
 .upload-area.has-file { border-color: var(--color-success); background: var(--color-success-light); }
        
 .drawing-preview { margin-top: var(--space-md); display: none; }
 .drawing-preview.visible { display: block; }
        
 .drawing-preview__image {
 width:200px; height:200px; object-fit: cover;
 border-radius: var(--radius-md); border:3px solid var(--color-success); box-shadow: var(--shadow-md);
 }
        
 .drawing-preview__info { margin-top: var(--space-sm); font-size: var(--font-size-sm); color: var(--color-success); }
        
 .drawing-preview__remove {
 margin-top: var(--space-sm); color: var(--color-error);
 background: none; border: none; cursor: pointer; font-size: var(--font-size-sm);
 }
        
 .drawing-preview__remove:hover { text-decoration: underline; }
        
 .modal--success .modal__content { max-width:500px; text-align: center; }
        
 .modal--success .modal__icon {
 width:80px; height:80px; background: var(--color-success-light);
 border-radius: var(--radius-full); display: flex; align-items: center; justify-content: center;
 margin:0 auto var(--space-lg); font-size:36px; color: var(--color-success);
 }
        
 .modal--success .modal__body { padding: var(--space-xl); }
        
 .loading-spinner {
 display: inline-block; width:20px; height:20px;
 border:2px solid #f3f3f3; border-top:2px solid var(--color-primary);
 border-radius:50%; animation: spin1s linear infinite;
 }
